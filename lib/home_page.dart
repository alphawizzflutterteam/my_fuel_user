  ...
  void _showBottomSheet(BuildContext context) {
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return StatefulBuilder(builder: (context, carsercice) {
          return SingleChildScrollView(
                      ...
                      InkWell(
                        onTap: () {
                          ...
                          if (vehicleNoController.text.toString().isEmpty) {
                            Fluttertoast.showToast(
                                msg: "Please Enter Vehicle Number".tr);
                          }
                      ...
                      child: GetBuilder<CarServiceController>(
                          ...
                          builder: (carController) {
                            return Obx(() => DropdownButton<VehicleData>(
                                  hint: Text('Select Your Vehicle Type'.tr),
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                Obx(() {
                                  print(
                                      "object dsdsdsdssdsf${homeController.servicesDetailModel.value.products!.length}");
