                                              ...
                                              return InkWell(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    const EdgeInsets.all(
                                                        10.0),
                                                    child: controller.allOrdersList[selectedIndex].name!='Insurance'  ?  Row(
                                                      children: [
                                                        ...
                                                        FadeInImage
                                                          ...
                                                          'assets/indianoil.png', // Placeholder image path
                                                          image:
                                                          '${configModel!.baseUrls!.categoryImageUrl}/${controller.allOrdersList[selectedIndex].bookings![index1].products?[0].images}', // Network image URL
                                                          imageErrorBuilder: (context,
                                                              error,
                                                              stackTrace) {
                                                            // Widget to display in case of an error
