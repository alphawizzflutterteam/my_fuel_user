                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                              ...
                                              Expanded(
                                                child: SizedBox(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    onChanged: (value) {
                                                      controller.searchOrderText.value = value;
                                                
                                                    },
                                                    decoration: InputDecoration(
                                                        hintText: "Search Order ID".tr,
                                                        ...
                                                        prefixIcon: SizedBox(
                                                            height: 20,
                                                            width: 20,
                                                            child: Image.asset( "assets/Search.png",scale: 20,)),
                                        ...
                                        controller
                                            .allOrdersList.isEmpty  ? Center(child: CircularProgressIndicator())  :   controller
                                            .allOrdersList[selectedIndex].name=='Insurance'  ?   ListView.builder(
                                          physics:
                                            ...
                                            return InkWell(
                                              ...
                                              child: Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child:  Row(
                                                    children: [
                                                      controller.allOrdersList[selectedIndex].bookings?[index1].products?.isEmpty ?? true ?
                                                      ...
                                                      //   },
                                                      // ),
                                                      controller.allOrdersList[selectedIndex].bookings?[index1].products?.isEmpty  ?? true ?  Padding(
                                                        padding:
                                                        const EdgeInsets
                                                            .symmetric(
                                                            horizontal:
                                                            ...
                                                            Container(
                                                              ...
                                                              decoration: BoxDecoration(
                                                                ...
                                                                BorderRadius
                                                                    .circular(
                                                                    6),
                                                                color:controller.allOrdersList[selectedIndex].bookings?[index1].status=='pending'  ?  Color(0xFFF6C209) : controller.allOrdersList[selectedIndex].bookings?[index1].status=='cancelled' ? Colors.red :   controller.allOrdersList[selectedIndex].bookings?[index1].status=='inprogress'  ||   controller.allOrdersList[selectedIndex].bookings?[index1].status=='confirmed'  ?
                                                            ...
                                                            Container(
                                                              ...
                                                              decoration: BoxDecoration(
                                                                ...
                                                                BorderRadius
                                                                    .circular(
                                                                    6),
                                                                color:controller.allOrdersList[selectedIndex].bookings?[index1].status=='pending'  ?  Color(0xFFF6C209) : controller.allOrdersList[selectedIndex].bookings?[index1].status=='inprogress'  ||   controller.allOrdersList[selectedIndex].bookings?[index1].status=='confirmed'  ?
